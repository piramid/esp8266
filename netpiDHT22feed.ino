...
const char* ssid     = "guitar";       // ชื่อ ssid
const char* password = "aaaaabbbbb";        // รหัสผ่าน wifi

#define APPID   "netpietrain"                       // ให้แทนที่ด้วย AppID รวม
#define KEY     "kEuE7PJWlgNl14p"                         // ให้แทนที่ด้วย Key รวม
#define SECRET  "yPSzWu1qwdLtX9xxsXS0rpWe1"                      // ให้แทนที่ด้วย Secret รวม

#define ALIAS   "A01"           // แทนที่ด้วยหมายเลขของท่าน เช่น "A01"
#define NEIGHBOR "sensorHumidTemp"             // ชื่ออุปกรณ์ของเพื่อน เช่น "A02"
// --------------------------------------------------------------------------------------
...
#define FEEDID   "tomnetpie"           // ให้แทนที่ด้วย FeedID
#define FEEDAPI  "cfEfKnkK6MBal859OMwjXXtg1QicHZXd"          // ให้แทนที่ด้วย FeedAPI
